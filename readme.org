...
#+begin_src emacs-lisp
  ...
  (key-chord-define-global "et" 'vterm)
  (key-chord-define-global "on" 'save-buffer)
  (key-chord-define-global "pg" 'projectile-switch-project)
  (key-chord-define-global "kl" 'fresh-start)
#+end_src
* Install flycheck
