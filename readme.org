...
Omit Emacs [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Backup-Names.html#Backup-Names][backup files]].
...
#+begin_src emacs-lisp
  (use-package org-roam
    :ensure t
    :bind (("C-c h" . org-roam-buffer-toggle)
           ("C-c f" . org-roam-node-find)
           ("C-c i" . org-roam-node-insert)
           ("C-c u" . org-roam-dailies-goto-today)
           ("C-c r" . org-roam-dailies-capture-today)
