...
Clone [[https://slime.common-lisp.dev/][slime]] to ~/git/slime.
...
1. Install Steal Bank Common Lisp
2. Clone the slime repository
...
You will need to [[https://www.quicklisp.org/beta/#installation][install quicklisp]] for this next part to work.
